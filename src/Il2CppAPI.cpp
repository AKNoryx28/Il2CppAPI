...
void il2cpp_init(const char *domain_name) {
    __android_log_print(ANDROID_LOG_INFO, IL2CPP_LOG_TAG, AY_OBFUSCATE("il2cpp_init: %s"), domain_name);
...
void Il2CppAPI::InitAPI(JNIEnv *env, const char *lib_name) {
   ...
   jobject context = env->CallObjectMethod(currentActivityThread, 
           env->GetMethodID(activityThread, "getApplication", "()Landroid/app/Application;"));

   jmethodID getAppInfo = env->GetMethodID(env->GetObjectClass(context), AY_OBFUSCATE("getApplicationInfo"), AY_OBFUSCATE("()Landroid/content/pm/ApplicationInfo;"));
...
void Il2CppAPI::Attach() {
    ...
    il2cpp_domain_get_assemblies = (void **(*)(const void *, size_t *)) dlsym(il2cpp, "il2cpp_domain_get_assemblies");
    il2cpp_class_from_name = (void *(*)(void *, const char *, const char *))dlsym(il2cpp, "il2cpp_class_from_name");
    il2cpp_domain_get = (void *(*)(void))dlsym(il2cpp, "il2cpp_domain_get");
    il2cpp_domain_assembly_open = (void *(*)(void *, const char *))dlsym(il2cpp, "il2cpp_domain_assembly_open");
    il2cpp_assembly_get_image = (void *(*)(void *))dlsym(il2cpp, "il2cpp_assembly_get_image");
    il2cpp_class_get_field_from_name = (void *(*)(void *, const char *))dlsym(il2cpp, "il2cpp_class_get_field_from_name");
    il2cpp_field_get_offset = (size_t (*)(void*))dlsym(il2cpp, "il2cpp_field_get_offset");
    il2cpp_field_get_value = (void (*)(void *, void *, void *))dlsym(il2cpp, "il2cpp_field_get_value");
    il2cpp_field_set_value = (void (*)(void *, void *, void *))dlsym(il2cpp, "il2cpp_field_set_value");
    il2cpp_field_static_get_value = (void (*)(void *, void *))dlsym(il2cpp, "il2cpp_field_static_get_value");
    il2cpp_field_static_set_value = (void (*)(void *, void *))dlsym(il2cpp, "il2cpp_field_static_set_value");
    il2cpp_field_get_type = (void *(*)(void *))dlsym(il2cpp, "il2cpp_field_get_type");
    il2cpp_field_get_flags = (int (*)(void *))dlsym(il2cpp, "il2cpp_field_get_flags");
    il2cpp_type_get_name = (char *(*)(void *))dlsym(il2cpp, "il2cpp_type_get_name");
    //il2cpp_type_get_attrs = (uint32_t (*)(void *))dlsym(il2cpp, "il2cpp_type_get_attrs");
    il2cpp_class_get_methods = (void *(*)(void *, void **))dlsym(il2cpp, "il2cpp_class_get_methods");
    il2cpp_class_get_method_from_name = (void *(*)(void *, const char *, int))dlsym(il2cpp, "il2cpp_class_get_method_from_name");
    il2cpp_method_get_name = (const char *(*)(void *))dlsym(il2cpp, "il2cpp_method_get_name");
    il2cpp_method_get_param_count = (uint32_t (*)(void *))dlsym(il2cpp, "il2cpp_method_get_param_count");
    il2cpp_method_get_param = (void *(*)(void *, uint32_t))dlsym(il2cpp, "il2cpp_method_get_param");
    il2cpp_string_new = (String *(*)(const char *))dlsym(il2cpp, "il2cpp_string_new");
    il2cpp_string_new_utf16 = (String *(*)(const wchar_t *, int32_t))dlsym(il2cpp, "il2cpp_string_new_utf16");
    il2cpp_object_new = (Object *(*)(void *))dlsym(il2cpp, "il2cpp_object_new");
    il2cpp_runtime_object_init = (void *(*)(void *))dlsym(il2cpp, "il2cpp_runtime_object_init");
    il2cpp_runtime_class_init = (void *(*)(void *))dlsym(il2cpp, "il2cpp_runtime_class_init");
    il2cpp_runtime_invoke = (void *(*)(void *, void *, void **, void **))dlsym(il2cpp, "il2cpp_runtime_invoke");
    il2cpp_thread_attach = (void *(*)(void *))dlsym(il2cpp, "il2cpp_thread_attach");
    il2cpp_thread_detach = (void (*)(void *))dlsym(il2cpp, "il2cpp_thread_detach");
...
void *Il2CppAPI::GetClassType(const char *image, const char *namespaze, const char *clazz) {
	...
	if (!klass) {
		__android_log_print(ANDROID_LOG_ERROR, IL2CPP_LOG_TAG, "Can't find class %s!", clazz);
		return 0;
	}
	cache[s] = klass;
	return klass;
...
Class *Il2CppAPI::CreateClassInstance(const char *image, const char *namespaze, const char *clazz) {
	...
	if (!obj) {
		__android_log_print(ANDROID_LOG_ERROR, IL2CPP_LOG_TAG, "Can't create object %s!", clazz);
		return 0;
	}
	return (Class*)obj;
}
...
void Il2CppAPI::GetFieldValue(const char *image, const char *namespaze, const char *clazz, const char *name, void *output) {
    ...
    if (!field) {
		__android_log_print(ANDROID_LOG_ERROR, IL2CPP_LOG_TAG, "Can't find field %s in class %s!", name, clazz);
		return;
	}
...
void *Il2CppAPI::GetMethodByName(const char *image, const char *namespaze, const char *clazz, const char *name, int argsCount) {
	...
	void *klass = GetClassType(image, namespaze, clazz);
	if (!klass) {
		__android_log_print(ANDROID_LOG_ERROR, IL2CPP_LOG_TAG, "Can't find method %s!", clazz, name);
		return 0;
	}
	void **method = (void**)il2cpp_class_get_method_from_name(klass, name, argsCount);
	if (!method) {
		__android_log_print(ANDROID_LOG_ERROR, IL2CPP_LOG_TAG, "Can't find method %s in class %s!", name, clazz);
		return 0;
	}
...
void *Il2CppAPI::GetMethodByName(const char *image, const char *namespaze, const char *clazz, const char *name, char **args, int argsCount) {
	...
	void *klass = GetClassType(image, namespaze, clazz);
	if (!klass) {
		__android_log_print(ANDROID_LOG_ERROR, IL2CPP_LOG_TAG, "Can't find class %s for method %s!", clazz, name);
		return nullptr;
	}
	void *iter = 0;
	int score = 0;
			...
			for (int i = 0; i < argsCount; i++) {
				...
				if (arg) {
					...
					if (strcmp(tname, args[i]) == 0) {
						...
						__android_log_print(ANDROID_LOG_INFO, IL2CPP_LOG_TAG, "Argument at index %d didn't matched requested argument!\n\tRequested: %s\n\tActual: %s\nnSkipping function...", i, args[i], tname);
						score = 0;
						goto skip;
					}
				}
	...
	__android_log_print(ANDROID_LOG_ERROR, IL2CPP_LOG_TAG, "Cannot find function %s in class %s!", name, clazz);
	return nullptr;
}
...
size_t Il2CppAPI::GetFieldByName(const char *image, const char *namespaze, const char *clazz, const char *name) {
	...
	void *klass = GetClassType(image, namespaze, clazz);
	if (!klass) {
		__android_log_print(ANDROID_LOG_ERROR, IL2CPP_LOG_TAG, "Can't find field %s!", clazz, name);
		return -1;
	}
	void *field = il2cpp_class_get_field_from_name(klass, name);
	if (!field) {
		__android_log_print(ANDROID_LOG_ERROR, IL2CPP_LOG_TAG, "Can't find field %s in class %s!", clazz, name);
		return -1;
	}
	auto result = il2cpp_field_get_offset(field);
	__android_log_print(ANDROID_LOG_DEBUG, IL2CPP_LOG_TAG, "%s - [%s] %s::%s: %p", image, namespaze, clazz, name, (void *) result);
	return result;
}
...
template<class T> Il2CppArray<T> *Il2CppArray<T>::Create(void *type, uintptr_t length) {
...
Il2CppTypes::Class *Il2CppAPI::CreateClassInstance(const std::string &imageNamespaceClass) {
    std::string imageName;
    std::string nameSpace;
    std::string className;
    ...
    return CreateClassInstance(imageName.c_str(), nameSpace.c_str(), className.c_str());
}

void Il2CppAPI::GetFieldValue(const std::string &imageNamespaceClass, const char *fieldName, void *output) {
    std::string imageName;
    std::string nameSpace;
    std::string className;
    ...
    return GetFieldValue(imageName.c_str(), nameSpace.c_str(), className.c_str(), fieldName, output);
}

void Il2CppAPI::SetFieldValue(const std::string &imageNamespaceClass, const char *fieldName, void* value) {
    std::string imageName;
    std::string nameSpace;
    std::string className;
...
void *Il2CppAPI::GetMethodByName(const std::string &imageNamespaceClass, const char *methodName, char **args, int argsCount) {
    ...
    return GetMethodByName(imageName.c_str(), nameSpace.c_str(), className.c_str(), methodName, args, argsCount);
}

size_t Il2CppAPI::GetFieldByName(const std::string &imageNamespaceClass, const char *fieldName) {
    std::string imageName;
    std::string nameSpace;
    std::string className;
    ...
    return GetFieldByName(imageName.c_str(), nameSpace.c_str(), className.c_str(), fieldName);
}
